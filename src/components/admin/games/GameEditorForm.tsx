    ...
    <div className="space-y-6 pb-16">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border/60 bg-surface/80 px-6 py-4 shadow-soft">
        <div className="flex flex-col gap-1 text-sm">
          ...
          <h1 className="text-xl font-semibold text-foreground">{game ? `Edit ${game.name}` : "Create game"}</h1>
      ...
      <form id="game-editor-form" className="space-y-8" onSubmit={onSubmit}>
        {activeTab === "content" ? (
          <section className="space-y-8">
            <div className="space-y-4 rounded-2xl border border-border/60 bg-surface/80 p-6 shadow-soft">
              <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-6 rounded-2xl border border-border/60 bg-surface/80 p-6 shadow-soft">
              <div className="space-y-2">
